...
public partial class TransactionHash : Node
{
    public class Call
    {
    ...
    public static class Hash
    {
        ...
        public static BigInteger HexToBigInteger(string hex)
        {
            ...
            try
            {
                ...
                {
                    GD.PrintErr("Error converting hex to BigInteger: Invalid hex string.");
                }
            ...
            {
                GD.PrintErr("Error converting hex to BigInteger: " + e.Message);
                throw;
            }
        }
